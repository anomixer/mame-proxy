...
void print_usaeg() {
    std::cout << "Usage: MameProxy -m <MountPoint> -c <CacheDir> -u <BaseUrl>" << std::endl;
    std::cout << "Example: MameProxy -m Z: -c C:\\MAME\\romcache -u https://mdk.cab/download/standalone/" << std::endl;
}
...
int main(int argc, char* argv[]) {
    ...
    std::wstring baseUrl = L"https://mdk.cab/download/standalone/";
    ...
    std::wcout << L"Starting MameProxy..." << std::endl;
